  ...
  const fetchImageInfo = async id => {
    ...
    const handleSearch = text => {
      ...
      if (text === '') {
        ...
        const filtered = images.filter(item => item.id.toString().startsWith(text));
      ...
      {loading ? (
        ...
        */
        <FlatList
          ...
          renderItem={({item}) => (
            <ImageCard item={item} onInfoPress={() => fetchImageInfo(item.id)} />
          )}
        />
      )}
        ...
        <View style={styles.modalContainer}>
          {selectedImage && (
            <View style={styles.modalContent}>
              ...
              <Text style={styles.modalText}>{strings.width} {selectedImage.width}</Text>
              <Text style={styles.modalText}>
